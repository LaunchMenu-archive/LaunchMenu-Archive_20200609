...
class GlobalData {
    ...
    constructor(ID) {
        ...
        _IPC2.default.on("GlobalData.notifyChange." + ID, this.dataListener);
    ...
    change(data) {
        ...
        return _IPC2.default.send("GlobalData.change", {
            ID: this.ID,
            data: data
        });
    }
    ...
    get(path = "") {
        ...
        while ((field = pathParts.shift()) && data && field.length > 0) data = data[field];
    ...
    dispose() {
        ...
        _IPC2.default.off("GlobalData.notifyChange." + ID, this.dataListener);
    }
        ...
        while (true) {
            ...
            if (listeners) {
                ...
                listeners.forEach(listener => {
                    listener.call(this, (0, _assign2.default)({}, event));
                });
            }
